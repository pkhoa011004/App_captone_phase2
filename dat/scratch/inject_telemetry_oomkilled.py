...
async def run_test():
    async with httpx.AsyncClient() as client:
        # In Scenario 2, memory threshold is hit, causing CrashLoopBackOff and probe failure
        metrics = [
            {
        ...
        start = time.time()
        print("Sending Scenario 2 telemetry to http://localhost:8080/dumbproxy/inject-batch...")
        try:
            ...
            print("\n[OK] Scenario 2 (OOMKilled/CrashLoop) metrics injected! Wait 1-2 minutes for Prometheus to trigger alerts.")
